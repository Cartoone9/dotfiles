-- Core Hyprland settings migrated from configs/SystemSettings.conf and laptop device settings.
...
hl.gesture({
  ...
  direction = "up",
  action = function()
    hl.dispatch(hl.dsp.exec_cmd((os.getenv("HOME") or "~") .. "/.config/hypr/scripts/OverviewToggle.sh"))
  end,
})
