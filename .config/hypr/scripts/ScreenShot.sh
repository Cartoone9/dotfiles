...
notify_cmd_shot="${notify_cmd_base} -i applets-screenshooter-symbolic "
notify_cmd_shot_win="${notify_cmd_base} -i applets-screenshooter-symbolic "
notify_cmd_NOT="notify-send -u low -i dialog-error-symbolic "
...
countdown() {
	for sec in $(seq $1 -1 1); do
		notify-send -h string:x-canonical-private-synchronous:shot-notify -t 1000 -i alarm-symbolic  " Taking shot" " in: $sec secs"
		sleep 1
	done
}
